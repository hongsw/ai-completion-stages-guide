...
- **Format:** Curated guide + practice roadmap + repository map
- **Audience:** 일반인 / 직장인 / 개발자 / 연구자 / 창업자
- **Goal:** 각 단계의 불편을 이해하고 다음 단계의 필요성을 체감하기
- **Top-level model:** 11-stage AI maturity path
- **Style reference:** awesome-* 오픈소스 리포처럼 빠르게 훑고 바로 들어갈 수 있는 랜딩형 README
...
또 한 가지 중요한 점은, 상위 단계가 단순히 “더 고급 모델을 쓴다”에 머물지 않는다는 것입니다.
우리가 참고한 외부 11단계 관점에서는 상위 구간을 다음처럼 봅니다.

- **10단계: 시스템 정의형 사용자**
  - 기존 도구를 잘 쓰는 사람을 넘어,
  - 어떤 인터페이스와 어떤 운영 구조가 다음 세대 AI 경험을 만드는지 **정의하고 설계하는 사람**
- **11단계: 프론티어 개척형 사용자**
  - 이미 알려진 흐름을 최적화하는 데서 끝나지 않고,
  - 새로운 멀티모달 상호작용, 환경화, 운영체제화, 연구 질문 자체를 **개척하는 사람**

즉, 이 리포는 AI 활용의 최상단을 단순 “논문도 읽는 고수”가 아니라,
**시스템을 정의하고 새로운 frontier를 여는 사용자/창업자/연구자**까지 포함하는 구조로 확장합니다.
...
그리고 최상위 구간에서는 질문이 달라집니다.

- 9단계까지가 “우리에게 맞는 모델/시스템을 구현하고 적용할 수 있는가?”라면
- 10단계는 “우리는 어떤 시스템 구조와 사용자 경험이 맞는지 정의할 수 있는가?”이고
- 11단계는 “아직 표준화되지 않은 새로운 AI 경험과 frontier를 먼저 열 수 있는가?”입니다.
...
### Level 10 — 시스템 정의형 사용자
- 단순 구현을 넘어, 인터페이스·환경·운영 방식을 정의하는 단계
...
### Level 11 — 프론티어 개척형 사용자
- 새로운 멀티모달 경험, 운영체제적 AI, 연구 문제 자체를 개척하는 단계
...
### Core docs
- **처음 보는 사람**: [`docs/guide.ko.md`](./docs/guide.ko.md)
- **영문 독자**: [`docs/guide.en.md`](./docs/guide.en.md)
- **레벨별 실습 로드맵**: [`docs/levels.ko.md`](./docs/levels.ko.md)
- **실습 체크리스트**: [`docs/checklist.ko.md`](./docs/checklist.ko.md)
- **오픈소스/논문 맵**: [`docs/sources.md`](./docs/sources.md)
- **언어별 번역 진입점**: [`docs/LANGUAGES.md`](./docs/LANGUAGES.md)

### By track
- 일반인 트랙: README 내 Mermaid 경로 참조
- 직장인 트랙: README 내 Mermaid 경로 참조
- 개발자 트랙: README 내 Mermaid 경로 참조
- 연구자 트랙: README 내 Mermaid 경로 참조
...
> 오픈소스, 서비스화, 모델 구현을 거쳐,
> 나아가 시스템 자체를 정의하고 새로운 frontier를 개척하는 수준까지
